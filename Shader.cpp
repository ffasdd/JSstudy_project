...
void CObjectsShader::CreateShader(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, D3D12_PRIMITIVE_TOPOLOGY_TYPE d3dPrimitiveTopologyType)
{
	CShader::CreateShader(pd3dDevice, pd3dCommandList, pd3dGraphicsRootSignature, d3dPrimitiveTopologyType);
}
